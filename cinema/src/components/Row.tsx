    ...
    <section className="h-80 flex flex-col md:flex-row px-6 md:px-12">
      <div className="uppercase flex flex-col justify-between md:w-96">
        ...
        <div className="flex justify-between items-center">
          <p className="mt-1 md:mt-0 text-xs md:text-sm uppercase text-gray-100 tracking-wider">Scroll To Next</p>
        </div>
      </div>
      <div className="mt-4 md:ml-12 md:mt-0 flex overflow-x-hidden overflow-x-scroll gap-x-4 w-full">
        {data && data.map((movie) => (
